        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <select value={formData.gender} onChange={(e) => setFormData({...formData, gender: e.target.value})}><option>Nam</option><option>Nữ</option></select>
            </div>
          </div>
          <div className="form-row">
            <div className="form-group">
          ...
          <div className="social-login">
            <button type="button" className="btn-social facebook"><span>🔵</span> Facebook</button>
            <button type="button" className="btn-social google"><span>🔴</span> Google</button>
          </div>
